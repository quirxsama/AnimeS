...
## 2025-05-23 - Filter List Usability
**Learning:** Long lists of filters (40+ categories) without search functionality force users to scroll excessively, creating friction.
**Action:** Always implement a search/filter input for filter lists containing more than 10 items.
