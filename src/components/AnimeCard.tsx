...
export default function AnimeCard({ anime }: AnimeCardProps) {
  return (
    <Link
      ...
      className="block h-full group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-lg"
    >
      <motion.div
      ...
      >
        ...
        <motion.div 
          ...
          whileHover={{ y: -8 }}
        >
          <h3 className="text-lg font-semibold mb-2 line-clamp-2 transition-all duration-300 group-hover:text-shadow group-hover:outline-text group-focus-visible:text-shadow group-focus-visible:outline-text">
            {anime.title}
          </h3>
